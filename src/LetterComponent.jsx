...
const LetterComponent = ({ barcode }) => {
  const LetterDate = new Date().toLocaleDateString(); // Example date
  ...
  return (
    <div>
      ...
      <p style={{ textAlign: "justify" }}>
        <p style={{ fontFamily: "Calibri, sans-serif", fontSize: "14px" }}>Dear Insured,</p>
        <p style={{ fontFamily: "Calibri, sans-serif", fontSize: "14px" }}>This is sample letter to verify intelligent mail barcode</p>
        <br />
        <p style={{ fontFamily: "Calibri, sans-serif", fontSize: "14px" }}>Thanks,</p>
        </p>
        {/* <span style={{ fontFamily: "Calibri, sans-serif", fontSize: "14px" }}>

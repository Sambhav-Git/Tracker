...
const LetterComponent = ({
  ...
  return (
    <div>
      ...
      <p style={{ textAlign: "justify" }}>
        <p style={{ fontFamily: "Calibri, sans-serif", fontSize: "12px" }}>
          ** Zipcode {data.zip}-{data.plus4} | Deleivery Point{" "}
          {data.delivery_pt} | Barcode Id {data.barcode_id} | Service Type {data.service_type} | Mailer ID {data.mailer_id} | Serial
          Number {data.serial_num}
        </p>
        {/* <p style={{ fontFamily: "Calibri, sans-serif", fontSize: "14px" }}>
          Service Type {data.service_type} | Mailer ID {data.mailer_id} | Serial
          Number {data.serial_num}
        </p> */}
        <p style={{ fontFamily: "Calibri, sans-serif", fontSize: "14px" }}>
          Dear {partyName},

  ...
  return (
    ...
    <div className="App">
      <Modal
        ...
        {brcde && <div className="barcode-box"><table className="barcodeClass" id="barcodetable" cellSpacing="0" border="0">
          <tbody>
            <tr>{top}</tr>
            <tr>{mid}</tr>
            <tr>{btm}</tr>
        ...
        <LetterComponent barcode={brcde} partyName={party.name} partyAddress={party.address} />
      </Modal>
